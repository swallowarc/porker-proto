...
@$core.Deprecated('Use resetRoomRequestDescriptor instead')
const ResetRoomRequest$json = const {
  '1': 'ResetRoomRequest',
  '2': const [
    const {'1': 'room_id', '3': 1, '4': 1, '5': 9, '10': 'roomId'},
    const {'1': 'login_id', '3': 2, '4': 1, '5': 9, '10': 'loginId'},
...
/// Descriptor for `ResetRoomRequest`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List resetRoomRequestDescriptor = $convert.base64Decode('ChBSZXNldFJvb21SZXF1ZXN0EhcKB3Jvb21faWQYASABKAlSBnJvb21JZBIZCghsb2dpbl9pZBgCIAEoCVIHbG9naW5JZA==');
