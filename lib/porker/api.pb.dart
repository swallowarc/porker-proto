...
class ResetRoomRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ResetRoomRequest', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'porker'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'roomId')
    ..aOS(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'loginId')
    ..hasRequiredFields = false
  ;

  ResetRoomRequest._() : super();
  factory ResetRoomRequest({
    $core.String? roomId,
    $core.String? loginId,
  }) {
    final _result = create();
  ...
  factory ResetRoomRequest.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory ResetRoomRequest.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  ResetRoomRequest clone() => ResetRoomRequest()..mergeFromMessage(this);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  ResetRoomRequest copyWith(void Function(ResetRoomRequest) updates) => super.copyWith((message) => updates(message as ResetRoomRequest)) as ResetRoomRequest; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static ResetRoomRequest create() => ResetRoomRequest._();
  ResetRoomRequest createEmptyInstance() => create();
  static $pb.PbList<ResetRoomRequest> createRepeated() => $pb.PbList<ResetRoomRequest>();
  @$core.pragma('dart2js:noInline')
  static ResetRoomRequest getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<ResetRoomRequest>(create);
  static ResetRoomRequest? _defaultInstance;
